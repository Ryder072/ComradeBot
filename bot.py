...
async def on_message(message):
    ...
    if 'communism' in message.content.lower() and pasta_perm:
    ...
    if 'mario' in message.content.lower() and pasta_perm:
        if message.author == client.user:
            return
    ...
    if 'seize' in message.content.lower() and pasta_perm:
        link = 'https://www.youtube.com/watch?v=U06jlgpMtQs'
        await client.send_message(message.channel, link)

    if 'leftist' in message.content.lower() and pasta_perm:
        if message.author == client.user:
            return
        ...
        await client.send_message(message.channel, pasta)
    if 'capitalism' in message.content.lower() and pasta_perm:
        if message.author == client.user:
            return
        ...
        await client.send_message(message.channel, pasta)
    if 'libtard' in message.content.lower() and pasta_perm:
        if message.author == client.user:
            return
